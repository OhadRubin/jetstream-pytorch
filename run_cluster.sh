...
# DISABLE_XLA2_PJRT_TEST="true" python3 /jetstream-pytorch/run_server_with_ray.py --tpu_chips=8 --num_hosts=2 --worker_chips=4 --model_name=llama-3 --size=7b --batch_size=30 --max_cache_length=2048 --sharding_config="default_shardings/llama.yaml" --tokenizer_path=/mnt/ramdisk/Llama-3.1-8B-Instruct/original/tokenizer.model --checkpoint_path=/mnt/ramdisk/Llama-3.1-8B-Instruct/merged.safetensors
